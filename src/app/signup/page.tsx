    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 409) setErrorMessage("Username sudah digunakan. Silakan pilih yang lain.");
                else if (response.status === 401) setErrorMessage("Username atau password tidak valid.");
                else setErrorMessage("Terjadi kesalahan server. Silakan coba lagi.");
            }
        } catch (error) {
            ...
            <div style={{
                ...
                <div style={{ textAlign: "center", marginBottom: "32px" }}>
                    ...
                    <p style={{ color: "#71717a", fontSize: "0.95rem" }}>
                        Bergabung dengan komunitas penulis Knowle
                    </p>
                </div>
