...
import { faQuestionCircle, faComments, faUser, faEye, faCalendar } from "@fortawesome/free-solid-svg-icons";
...
export default function QuestionsPage() {
    ...
    async function fetchPosts(page: number, isInitial = false) {
        ...
        try {
            const response = await fetch(`/api/book/get/questions?page=${page}&limit=12`);
                ...
                <div className="container">
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <FontAwesomeIcon icon={faQuestionCircle} style={{ color: "#f59e0b", fontSize: "1rem" }} />
                        </div>
                        <div>
                            <h1 style={{
                                fontSize: "1.5rem",
                    ...
                    {posts.length > 0 ? (
                                ...
                                >
                                    <article style={{
                                        ...
                                        onMouseOver={(e) => {
                                            ...
                                            (e.currentTarget as HTMLElement).style.boxShadow = "0 20px 40px rgba(245,158,11,0.15)";
                                        }}
                                        onMouseOut={(e) => {
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            position: "relative",
                                            height: post.cover ? "180px" : "100px",
                                            overflow: "hidden",
                                            background: post.cover ? "#f1f5f9" : "linear-gradient(135deg, #f59e0b 0%, #fbbf24 50%, #fcd34d 100%)",
                                        }}>
                                            {post.cover && (
                                                <>
                                                    <img
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <FontAwesomeIcon icon={faComments} style={{ fontSize: "1.5rem", color: "#f59e0b" }} />
                            </div>
                            <h3 style={{ fontWeight: 600, marginBottom: "8px", color: "#1e293b" }}>
                                Belum ada diskusi
                            </h3>
                            <p style={{ color: "#64748b", marginBottom: "20px" }}>
                                Mulai diskusi dengan mengajukan pertanyaan!
                            </p>
                            <a
                                href="/book/add"
                                style={{
